---
title: 'NÍVEL DE ATIVIDADE </br> (AULA 05)'
...
ibc_br_sa <- BETS::BETSget(24364, data.frame = T) %>% 
  ...
  ggplot2::labs(title = 'Índice de Atividade Econômica do Banco Central (IBC-Br)',
                ...
                y = 'Índice (Base: 2002 = 100 com ajuste sazonal)',
...
pim_sa <- sidrar::get_sidra(api = '/t/3651/n1/all/v/3134/p/all/c543/129278,129283,129300/d/v3134%201',
  ...
  ggplot2::labs(title = 'Pesquisa Industrial Mensal Produção Física (PIM-PF)',
                ...
                y = 'Índice (Base: 2012 = 100 com ajuste sazonal)') +
...
- Utilização da Capacidade Instalada (**UCI - FGV**):
  ...
  - Não há disponibilidade de dados com ajuste sazonal;
...
## O BRASIL EM PERSPECTIVA: UCI - FGV
...
UCI_dados <- BETS::BETSget(1344, data.frame = T) %>% 
...
UCI <- UCI_dados %>% 
  ...
  ggplot2::labs(title = 'Utilização da Capacidade Instalada (UCI - FGV)',
...
UCI <- plotly::ggplotly(UCI)


widgetframe::frameWidget(UCI, width = '100%', height = '100%')
...
pms_sa <- sidrar::get_sidra(api = '/t/6442/n1/all/v/all/p/all/c11046/40312/d/v8676%201,v8677%201',
  ...
  ggplot2::labs(title = 'Pesquisa Mensal de Serviços (PMS)',
                ...
                y = 'Índice (Base: 2014 = 100 com ajuste sazonal)') +
